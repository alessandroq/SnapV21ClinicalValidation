$(document).ready(function() {
  ...
  function initialize() {
    ...
    firstProcessAtLogIn = 'eQualificationProcess';
  ...
  function on_Label_TQL1lblTopRight_CLICK(e) {
    try {
      ...
      $('[obj-name="TQL1imgHourglass"]').show(); // Block#: 2Y@[o8%nlgS9Dvf/w;#!
  ...
  function on_listview_cell_clicked_TQL1lsvCell(TQL1lsvCell, number) {
    try {
  ...
  com.fc.JavaScriptDistLib.ListView.setClickCallback('TQL1lsvCell', on_listview_cell_clicked_TQL1lsvCell);
  ...
  function on_listview_length_configured_TQL1lsv() {
    try {
      com.fc.JavaScriptDistLib.ListView.configureCells('TQL1lsv', LVcells);
      $('[obj-name="TQL1lsv"]').children().each(function(i) {
        if(i > 0) {
          com.fc.JavaScriptDistLib.ListView.setContext($(this));
          com.fc.JavaScriptDistLib.ListView.executeConfigCallback('TQL1lsv', i - 1);
  ...
  function on_listview_cell_configured_TQL1lsvCell(TQL1lsvCell, number) {
    try {
  ...
  com.fc.JavaScriptDistLib.ListView.setConfigCallback('TQL1lsvCell', on_listview_cell_configured_TQL1lsvCell);
